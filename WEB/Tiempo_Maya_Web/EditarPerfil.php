    ...
    <div class="container-fluid mt--7" >
      <div class="row">
        ...
        <div class="col-xl-6 order-xl-2" style="margin-top: 250px;">
            <form action="./backend/EditarPerfil.php" method="post">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="username" class="form-control form-control-alternative" placeholder="<?php echo $_SESSION['nombre'] ?>" />
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Correo</label>
                        <input type="email" name="email" class="form-control form-control-alternative" placeholder="<?php
                                                          $username = $_SESSION['nombre'];
                                                          $consulta = "SELECT * FROM usuario WHERE username = '$username'";
                                                          $result = mysqli_query($conn, $consulta);
                                                          $datos = $result->fetch_array(MYSQLI_ASSOC);
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text " name="nombres" class="form-control form-control-alternative" placeholder="<?php
                                                        $username = $_SESSION['nombre'];
                                                        $consulta = "SELECT * FROM usuario WHERE username = '$username'";
                                                        $result = mysqli_query($conn, $consulta);
                                                        $datos = $result->fetch_array(MYSQLI_ASSOC);
                    ...
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="apellidos" class="form-control form-control-alternative" placeholder="<?php
                                                          $username = $_SESSION['nombre'];
                                                          $consulta = "SELECT * FROM usuario WHERE username = '$username'";
                                                          $result = mysqli_query($conn, $consulta);
                                                          $datos = $result->fetch_array(MYSQLI_ASSOC);
                    ...
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Nacimiento</label>
                        <input type="date" name="nacimiento" class="form-control form-control-alternative"/>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group focused">
                        ...
                        <input name="telefono" class="form-control form-control-alternative" placeholder="<?php
                                                    $username = $_SESSION['nombre'];
                                                    $consulta = "SELECT * FROM usuario WHERE username = '$username'";
                                                    $result = mysqli_query($conn, $consulta);
                                                    $datos = $result->fetch_array(MYSQLI_ASSOC);
