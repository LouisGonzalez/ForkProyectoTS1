...
<div>
	...
	<section id='inicio'><br><br><br><br><br>
      <div class="container">
    	<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="./backend/inicioSesion.php" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="user" id="InputUser" tabindex="1" class="form-control" placeholder="Usuario" value="" required>
									</div>
									<div class="form-group">
										<input type="password" name="password" id="InputPass" tabindex="2" class="form-control" placeholder="Contraseña" required>
									</div>
								...
								<form id="register-form" action="./backend/NuevoUsuario.php" method="post" role="form" style="display: none;">
									<div class='form-group'>
										<input type='text' name='nombres' id='nombres' tabindex='1' class='form-control' placeholder='Nombres'value='' required>
									</div>
									<div class='form-group'>
									...
									<div class='form-group'>
										<input type='date' name='nacimiento' id='nacimiento' tabindex='1' class='form-control' value='' required>
									</div>	
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
